...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.testSeries.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.test-seriess.update", [$test_seriess->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="heading">{{ trans('cruds.testSeries.fields.heading') }}</label>
                <input class="form-control {{ $errors->has('heading') ? 'is-invalid' : '' }}" type="text" name="heading" id="heading" value="{{ old('heading', $test_seriess->heading) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $test_seriess->slug) }}" required>
                @if($errors->has('slug'))
                    <div class="invalid-feedback">
                        {{ $errors->first('slug') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_heading') ? 'is-invalid' : '' }}" type="text" name="sub_heading" id="sub_heading" value="{{ old('sub_heading', $test_seriess->sub_heading) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" name="language" id="language">
                    ...
                    @foreach(App\Models\TestSeries::LANGUAGE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('language', $test_seriess->language) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text" name="duration" id="duration" value="{{ old('duration', $test_seriess->duration) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_lectures') ? 'is-invalid' : '' }}" type="text" name="video_lectures" id="video_lectures" value="{{ old('video_lectures', $test_seriess->video_lectures) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('questions_count') ? 'is-invalid' : '' }}" type="text" name="questions_count" id="questions_count" value="{{ old('questions_count', $test_seriess->questions_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('enrolment_deadline_date') ? 'is-invalid' : '' }}" type="text" name="enrolment_deadline_date" id="enrolment_deadline_date" value="{{ old('enrolment_deadline_date', $test_seriess->enrolment_deadline_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $test_seriess->price) }}" step="1">
                @if($errors->has('price'))
                    <div class="invalid-feedback">
                        {{ $errors->first('price') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description" id="short_description">{{ old('short_description', $test_seriess->short_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('long_description') ? 'is-invalid' : '' }}" name="long_description" id="long_description">{{ old('long_description', $test_seriess->long_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content">{!! old('content', $test_seriess->content) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('extra_content') ? 'is-invalid' : '' }}" name="extra_content" id="extra_content">{!! old('extra_content', $test_seriess->extra_content) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('featured_image_caption') ? 'is-invalid' : '' }}" type="text" name="featured_image_caption" id="featured_image_caption" value="{{ old('featured_image_caption', $test_seriess->featured_image_caption) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('faculties') ? 'is-invalid' : '' }}" name="faculties[]" id="faculties" multiple>
                    @foreach($faculties as $id => $faculty)
                        <option value="{{ $id }}" {{ (in_array($id, old('faculties', [])) || $test_seriess->faculties->contains($id)) ? 'selected' : '' }}>{{ $faculty }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('test_series_categories') ? 'is-invalid' : '' }}" name="test_series_categories[]" id="test_series_categories" multiple>
                    @foreach($test_series_categories as $id => $test_series_category)
                        <option value="{{ $id }}" {{ (in_array($id, old('test_series_categories', [])) || $test_seriess->test_series_categories->contains($id)) ? 'selected' : '' }}>{{ $test_series_category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $test_seriess->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $test_seriess->active || old('active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sequence') ? 'is-invalid' : '' }}" type="number" name="sequence" id="sequence" value="{{ old('sequence', $test_seriess->sequence) }}" step="1">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                data.append('crud_id', '{{ $test_seriess->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
...
<script>
    ...
    init: function () {
@if(isset($test_seriess) && $test_seriess->featured_image)
  var file = {!! json_encode($test_seriess->featured_image) !!}
...
<script>
    ...
    init: function () {
@if(isset($test_seriess) && $test_seriess->timetable)
  var file = {!! json_encode($test_seriess->timetable) !!}
      this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
      file.previewElement.classList.add('dz-complete')
