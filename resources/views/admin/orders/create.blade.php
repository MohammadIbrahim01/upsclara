    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', 'India') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('test_series') ? 'is-invalid' : '' }}" name="test_series[]" id="test_series" multiple>
                    @foreach($test_series as $id => $test_series)
                        <option value="{{ $id }}" {{ in_array($id, old('test_series', [])) ? 'selected' : '' }}>{{ $test_series }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gross_amount') ? 'is-invalid' : '' }}" type="number" name="gross_amount" id="gross_amount" value="{{ old('gross_amount', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_amount') ? 'is-invalid' : '' }}" type="number" name="discount_amount" id="discount_amount" value="{{ old('discount_amount', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('net_amount') ? 'is-invalid' : '' }}" type="number" name="net_amount" id="net_amount" value="{{ old('net_amount', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('promo_code_applied') ? 'is-invalid' : '' }}" type="text" name="promo_code_applied" id="promo_code_applied" value="{{ old('promo_code_applied', '') }}">
