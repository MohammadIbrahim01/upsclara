        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.courses.update', [$course->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('heading') ? 'is-invalid' : '' }}" type="text"
                        name="heading" id="heading" value="{{ old('heading', $course->heading) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sub_heading') ? 'is-invalid' : '' }}" type="text"
                        name="sub_heading" id="sub_heading" value="{{ old('sub_heading', $course->sub_heading) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" name="language"
                        ...
                        @foreach (App\Models\Course::LANGUAGE_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('language', $course->language) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text"
                        name="duration" id="duration" value="{{ old('duration', $course->duration) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('video_lectures') ? 'is-invalid' : '' }}" type="text"
                        name="video_lectures" id="video_lectures"
                        value="{{ old('video_lectures', $course->video_lectures) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('questions_count') ? 'is-invalid' : '' }}" type="text"
                        name="questions_count" id="questions_count"
                        value="{{ old('questions_count', $course->questions_count) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('enrolment_deadline_date') ? 'is-invalid' : '' }}"
                        type="text" name="enrolment_deadline_date" id="enrolment_deadline_date"
                        value="{{ old('enrolment_deadline_date', $course->enrolment_deadline_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number"
                        name="price" id="price" value="{{ old('price', $course->price) }}" step="1">
                    @if ($errors->has('price'))
                        <div class="invalid-feedback">
                            {{ $errors->first('price') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description"
                        id="short_description">{{ old('short_description', $course->short_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('long_description') ? 'is-invalid' : '' }}" name="long_description"
                        id="long_description">{{ old('long_description', $course->long_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('extra_content') ? 'is-invalid' : '' }}" name="extra_content"
                        id="extra_content">{!! old('extra_content', $course->extra_content) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('featured_image_caption') ? 'is-invalid' : '' }}"
                        type="text" name="featured_image_caption" id="featured_image_caption"
                        value="{{ old('featured_image_caption', $course->featured_image_caption) }}">
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('study_material') ? 'is-invalid' : '' }}"
                        id="study_material-dropzone">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('timetable') ? 'is-invalid' : '' }}"
                        id="timetable-dropzone">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('faculties') ? 'is-invalid' : '' }}"
                        name="faculties[]" id="faculties" multiple>
                        @foreach ($faculties as $id => $faculty)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('faculties', [])) || $course->faculties->contains($id) ? 'selected' : '' }}>
                                {{ $faculty }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('course_categories') ? 'is-invalid' : '' }}"
                        name="course_categories[]" id="course_categories" multiple>
                        @foreach ($course_categories as $id => $course_category)
                            <option value="{{ $id }}"
                                {{ in_array($id, old('course_categories', [])) || $course->course_categories->contains($id) ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1"
                            {{ $course->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                            for="featured">{{ trans('cruds.course.fields.featured') }}</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="active" id="active" value="1"
                            {{ $course->active || old('active', 0) === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sequence') ? 'is-invalid' : '' }}" type="number"
                        name="sequence" id="sequence" value="{{ old('sequence', $course->sequence) }}"
                        step="1">
