...
class AddressController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Address::with(['company'])->select(sprintf('%s.*', (new Address)->table));
        ...
        return view('admin.addresses.index', compact('companies'));
    }
    ...
    public function edit(Address $address)
    {
        ...
        return view('admin.addresses.edit', compact('address', 'companies'));
    }
